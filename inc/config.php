...
// Add your Data Base credentials here!
    $dbhost = "localhost";  // put here your DB adress
    $dbname = ""; // your DB name
...
// Here we define all Dogecoin Core Versions to be found and displyed on bottom of the Map
    $DogeNodeVersions = array("1.14.5","1.14.6","1.21");

// What Word to find on Twitter to show the last post on Doge Nodes Map?
    $TwitterWordFinder = "WhatisDogecoin";

// Here we difine the message and link that shows on top right
    $DogeNodesTopMessage = "Upgrade your Dogecoin Node to 1.14.5 Here!";
    $DogeNodesTopMessageLink = "https://dogecoin.com/#wallets";
