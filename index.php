...
<!-- Here we show a cool Doge Minner wen the page is loading -->
  ...
  <body>
    ...
    <?php if ($DogeNodesTopMessage != ""){ ?>
    <div class="col" style="position: absolute; top: 0px; right: 40px; padding: 0px; margin: 0px; text-align: right;">
    <button type="button" class="btn btn-dark" style="background-color: rgba(10, 0, 0, 0.5)">
        <a href="<?php echo $DogeNodesTopMessageLink; ?>"><span class="badge bg-warning" style="color: rgba(0, 0, 0, 1); background-color: rgba(255, 193, 7, 0.51)"><?php echo $DogeNodesTopMessage; ?></span></a>
    </button>
    </div>
    <?php }; ?>
